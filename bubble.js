...
function myFunction5() {
  document.getElementById("bubble_1").style.backgroundColor = "grey";
  document.getElementById("bubble_2").style.backgroundColor = "blue";
  document.getElementById("bubble_3").style.backgroundColor = "red";
  document.getElementById("bubble_4").style.backgroundColor = "green";
  document.getElementById("btn").style.backgroundColor = "lightgreen";
  document.getElementById("arrow_1").style.marginLeft = "80%";
